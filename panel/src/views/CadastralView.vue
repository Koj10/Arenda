      ...
      <div class="panel-card p-5 border-emerald-brand/20 bg-emerald-brand/5">
        ...
        <ol class="space-y-2 text-sm text-slate-400 list-decimal list-inside">
          ...
          <li>
            ...
            Один кадастр — площадь всего объекта; после разделения исходный номер удаляется,
            его помещения возвращаются в нераспределённые, у новых номеров остаются площади из сплита.
          </li>
        </ol>
      </div>

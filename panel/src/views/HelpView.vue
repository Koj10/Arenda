...
import { HelpCircle, Mail, BookOpen } from '@lucide/vue'
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Кнопка чата в правом нижнем углу. Напишите сообщение — оно уйдёт в поддержку.',
  },
]
</script>
    ...
    <div class="panel-page-narrow space-y-6">
      <section class="panel-card p-5 sm:p-6">
        ...
        <p class="text-sm text-slate-400 leading-relaxed">
          Краткие ответы по работе панели. Вопросы — через чат справа внизу.
        </p>
      </section>

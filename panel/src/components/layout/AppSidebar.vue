...
import { BarChart2, Building2, Landmark, Users, Calculator, Receipt, Settings, HelpCircle, LogOut, Sparkles, FileText } from '@lucide/vue'
...
const menuItems = [
  ...
  { to: '/landlord/documents', label: 'Документы', icon: FileText },
